...
export const chips: Chip[] = [
  // ── орбита вокруг чат-карточки (карточка 375×305, центр = 0,0) ──
  // Два пояса — над карточкой и под ней: по бокам места нет (слева
  // заголовок, справа край экрана на 1024–1280). Зазор до карточки и до
  // заголовка ≥ 25px в базовом масштабе; dx + полуширина чипа ≤ 285.
  {
    id: 1,
    label: "AI-агенты",
    Icon: Bot,
