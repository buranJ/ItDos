...
export const resources: ResourceDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "experience", label: "Опыт", type: "text", help: "Одна строка, например «5+ лет во frontend»" },
      { name: "focus", label: "Отвечает за", type: "stringList", help: "2–3 коротких пункта" },
      { name: "skills", label: "Навыки", type: "stringList", help: "До 5 технологий" },
      positionField,
      publishField,
    ],
  },
