...
export const plans: Plan[] = [
  ...
  {
    name: "Телеграм-боты / Автоматизация процессов",
    tagline: "Рутина уходит боту, заявки — в CRM",
    price: "Индивидуально",
    period: "обсуждается",
    features: [
      "Приём заявок и заказов в боте",
      "Оплата и уведомления в чате",
      "Интеграция с CRM и таблицами",
      "Рассылки и автоответы",
      "Админ-панель для менеджеров",
      "Сценарии без участия сотрудника",
